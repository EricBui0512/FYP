	                		...
	                		<input type="hidden" name="amount" value="{{$detail->discount}}">
		                   	<div class="row">
			                   	<div class="col-md-3">
				                      ...
				                      <input type="text" name="phone_number" required class="form-control col-md-6" placeholder="(+84)xxxx.xxxx.xxxx">
				                   	</div>
				                   	<div class="form-group">
				                      <label class="control-label">Quanity *</label>
				                      <input id="qty" type="number" name="qty" required class="form-control" value="1">
				                   	</div>
			                   	</div>
